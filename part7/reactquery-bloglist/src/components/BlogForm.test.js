...
describe("Tests the rendering of the BlogForm component", () => {
  ...
  beforeEach(() => {
    container = render(<BlogForm create={createHandler} />).container;
  ...
  test("Tests the rendering and functionality of component", async () => {
    ...
    expect(createHandler.mock.calls[0][0].title).toBe("Dummy Title");
    expect(createHandler.mock.calls[0][0].author).toBe("Dummy Author");
    expect(createHandler.mock.calls[0][0].url).toBe("http://dummyurl");
  });
});
